...
public class SendingPMessages {
	private int numberA;
	//parameters pass via this constructor
		public SendingPMessages(int numberA) {
    ...
    public void test() throws MalformedURLException, InterruptedException {
		...
		AndroidDriver driver = new AndroidDriver(new URL("http://127.0.0.1:4031/wd/hub"), cap);
		cap.setCapability(MobileCapabilityType.NEW_COMMAND_TIMEOUT, "2000");
