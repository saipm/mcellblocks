...
import io.appium.java_client.remote.MobilePlatform;
 ...
 //ile appDir = new File("/home/saisreem/workspace/junittest/");
     File app = new File("/home/saisreem/workspace/junittest/","Trillian_3.1.0.12.apk");
 ...
 a.get(1).click();
 driver.findElementById("com.ceruleanstudios.trillian.android:id/ShortLoginScreen_Edit_Username").sendKeys("saisreepm");
 driver.findElementById("com.ceruleanstudios.trillian.android:id/ShortLoginScreen_Edit_Password").sendKeys("saipm123");
 ...
 Thread.sleep(10000);
 /*List<WebElement>b=driver.findElements(By.className("android.widget.Button"));
 b.get(0).click();*/
...
driver.findElementByClassName("android.app.ActionBar$Tab").click();
 ...
 d.get(1).click();
 driver.findElementById("com.ceruleanstudios.trillian.android:id/ContactListScreen_ContactListTree_Contact_Name").click();
